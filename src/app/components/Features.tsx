...
const Shield: Item['Icon'] = (props) => (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" style={{ color: 'var(--primary-color)' }} strokeWidth="1.5" {...props}>
        <path d="M12 3l7 3v5c0 5-3.5 8.5-7 10-3.5-1.5-7-5-7-10V6l7-3z" />
    </svg>
)
const Cog: Item['Icon'] = (props) => (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" style={{ color: 'var(--primary-color)' }} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
const ITEMS: Item[] = [
    {
        ...
        body: 'Wij brengen structuur, richting en samenhang in het digitale landschap. Van datagedreven werken tot governance en samenwerking: wij slaan de brug tussen beleid en technologie.',
        Icon: Shield,
