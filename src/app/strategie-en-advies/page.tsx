            ...
            <div className="container">
                ...
                <ContentBlock
                    ...
                    points={[
                        ...
                        '<strong>Uitvoeringsvraagstukken →</strong> Wij helpen overheden om hun uitvoering toekomstbestendig te maken: door processen te herontwerpen, informatiestromen te verbeteren en systemen goed op elkaar aan te sluiten. Wij helpen bij opgaven als de invoering van het Digitaal Stelsel Omgevingswet <span class="accent-500">(DSO)</span>, de uitvoering van de Wet modernisering elektronisch bestuurlijk verkeer <span class="accent-500">(Wmebv)</span>, de Wet open overheid <span class="accent-500">(Woo)</span> en zaakgericht werken <span class="accent-500">(ZGW)</span>.',
